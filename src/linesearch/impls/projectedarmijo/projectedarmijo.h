...
typedef struct {
  ...
  TaoInt memorySize;		// Number of functions kept in memory
  TaoInt current;			// Current element for FIFO
  TaoInt referencePolicy;		// Integer for reference calculation rule
  TaoInt replacementPolicy;	// Policy for replacing values in memory
} TAO_PROJECTEDARMIJO;
