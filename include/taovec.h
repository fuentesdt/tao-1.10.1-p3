...
public:
  ...
  int CloneVecs(TaoInt, TaoVec***);
  int DestroyVecs(TaoInt, TaoVec**);
  ...
  */
  ...
  virtual int GetDimension( TaoInt* );
  ...
  virtual int GetArray(TaoScalar **, TaoInt*);
  virtual int RestoreArray(TaoScalar **, TaoInt*);
};
